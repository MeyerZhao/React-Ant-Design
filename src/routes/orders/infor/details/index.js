...
const columns = [{
  ...
  title: '确认时间（接单方）', dataIndex: 'item2', key: 'item2', }, {
  title: '修改时间（接单方）', dataIndex: 'item3', key: 'item3', }, {
  title: '复核确认时间（下单方）', dataIndex: 'item4', key: 'item4', }, {
  title: '关闭时间', dataIndex: 'item5', key: 'item5', }];
